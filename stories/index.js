...
storiesOf("InterviewerList", module)
  ...
  .add("Selected", () => (
    <InterviewerList
      interviewers={interviewers}
      // interviewer={3} //random id of interviewer.
      value={3}
    />
  ))
  .add("Clickable", () => (
...
storiesOf("Appointment", module)
  ...
  .add("Show", () => <Show student="Lydia Miller-joines" interviewer={interviewer} onEdit={action("onEdit")} onDelete={action("onDelete")} />)
  ...
  .add("Create", () => <Form interviewers={interviewers} onSave={action("I am Save")} onCancel={action("I am Cancel")} />)
